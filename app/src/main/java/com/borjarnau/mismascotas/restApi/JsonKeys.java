...
public final class JsonKeys {
    ...
    public static final String ID_IMAGES = "id";



    public static final String ID_REGISTRO = "id_regristro";
    public static final String ID_DISPOSITIVO = "id_dispositivo";
    public static final String NOMBRE_USUARIO_INSTAGRAM = " nombre_usuario_instagram";
